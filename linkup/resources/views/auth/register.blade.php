...
<div class="auth-card">
    ...
    <form action="{{ route('register.submit') }}" method="POST">
        ...
        <div class="form-group">
            <label>Titre professionnel (Headline)</label>
            <input type="text" name="headline" placeholder="Ex: Étudiant Web Dev / Développeur PHP" value="{{ old('headline') }}" required>
            @error('headline') <div class="error">{{ $message }}</div> @enderror
        </div>
